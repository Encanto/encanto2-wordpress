...
<?php if (get_post_meta($post_id, "rnr_assign_type", true) == "parallax-section") { ?>
	...
	<div id="<?php echo $post_name; ?>" class="parallax">
		...
		<div class="container clearfix">
      	...
      	<?php if ( $post_name === 'successful-applications' ):?>
				<ul class="posts">
					<li class="first">
					<div class="vertical-center-verticals">
						<h3>Supply Chain</h3>
						<p>Have precisely the right resources in the right places at the right times</p>
					</div>
					</li>
					<li class="second">
					<div class="vertical-center-verticals">
						<h3>Manufacturing</h3>
						<p>Efficiently produce the best products every time</p>
					</div>
					</li>
					<li class="third">
					<div class="vertical-center-verticals">
						<h3>Finance</h3>
						<p>Know what the bottom dollar, euro, pound, ruble, yuan really means to each LOB</p>
					</li>		
					<li class="third">
					<div class="vertical-center-verticals">
						<h3>Operations</h3>
						<p>Have the birds eye view of all LOBs, investments, organizational losses and efficiencies</p>
					</div>
					</li>
					<li class="fourth">
					<div class="vertical-center-verticals">
						<h3> R&D</h3>
						<p>Identify the break even point for new products and new markets</p>
					</div>
					</li>
					<li class="first">
					<div class="vertical-center-verticals">
						<h3>Governance</h3>
						<p>Detailed visibility and controls over your global organization</p>
					</div>
					</li>		
					<li class="second">
					<div class="vertical-center-verticals">
						<h3>More</h3>
						<p>We can most certainly help you identify your loss and profit identification needs</p>
					</div>
					</li>																
				</ul>
