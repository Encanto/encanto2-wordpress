...
add_action('admin_enqueue_scripts', 'rocknrolla_admin_scripts');
	...
	if (!is_admin() ){
		function rocknrolla_front_scripts(){		
			...
			wp_register_script('rnrLazyLoad', RNR_INDEX_JS .'/jquery.lazyload.min.js', true);	
			wp_register_script('rnrInfScr', RNR_INDEX_JS .'/jquery.infinitescroll.min.js', true);			
			...
			wp_register_script('rnrVimeoBgVideo', RNR_INDEX_JS .'/okvideo.min.js', true);	
			wp_register_script('rnrInfScr', RNR_INDEX_JS .'/jquery.infinitescroll.min.js', true);		
